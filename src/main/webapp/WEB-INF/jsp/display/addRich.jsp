		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form class="form-horizontal" role="form" id="addform">
					...
					<input type="hidden" id="groupid"  value="${groupid}" name="groundid">
				   ...
				   <div class="form-group">
				    ...
				    <label for="deadline" class="col-sm-2 control-label" style="padding-top: 4px;margin-bottom: 0;text-align: right;
    font-size: 16px;
    ">公示期限</label>
				    <div class="col-sm-2">
				  ...
				  <div class="form-group">
				    <div class="col-sm-offset-2 col-sm-10">
				      	<button type="button" class="btn btn-theme" id="submitBtn">添加</button>
						<button type="reset" class="btn btn-theme-cancel" onclick="history.back();">取消</button>
				    </div>
				  </div>
				</form>
			</div>
			...
			function() {
				...
				var groupid = $("#groupid").val();
					$.ajax({
						...
						type : "post",
						data : formData,
						url : "${basePath}rest/rich/addRich/"+menuid,
						success : function(data) {
							console.log(data);
							// 解析数据
							if (data.status == true) {
								parent.parent.layer.msg("内容添加成功！");
