				...
				<form class="form-horizontal" role="form" id="addform">
				    ...
				    <div class="form-group">
				  	 ...
				  	 <div class="form-group">
				    	...
				    	<div class="col-sm-10">
				      		<textarea class="form-control" rows="6" name="achievementsummary" id="achievementsummary" placeholder="请输入成果摘要..."></textarea>
				    	</div>
				  	</div>
				  	<!-- <div class="form-group">
				     	<label for="username" class="col-sm-2 control-label" style="padding-top: 0px;">应用情况及利益：</label>
				    	<div class="col-sm-10">
				      		<textarea class="form-control" rows="6" name="achievementdetails" id="achievementdetails" placeholder="请输入应用情况及利益..."></textarea>
				    	</div>
				  	</div>
				  	<div class="form-group">
				  	...
				  	<div class="form-group">
				    	...
				    	<div class="col-sm-10">
				    		<div id="showUploadImgDiv" class="rows"></div>
				      		<button type="button" class="btn btn-primary" id="uploadBg" >点击上传</button><span sytle="color:red;">*每次上传一张，可以上传多张</span>
				    	</div>
				  	</div>
				  	<div class="form-group">
	   ...
	   <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="myModalLabel"><span class="modalHeadTitle">上传示例图片</span><span class="modalTitleRemark">注：请上传330*330的矢量图</span></h4>
	      </div>
					...
					$.ajax({
						...
						success:function(data){
							...
							if(data.msg=='success'){
								...
								html += "<div class='col-sm-4' style='text-align:center'><img src='${basePath}static/web/img/smallInnovate/"+imgName+"' style='width: 200px;height: 300px;margin-bottom: 20px;margin-right: 20px;'> <button type='button' class='btn btn-success delete' data-name='"+imgName+"'>删除</button></div>"
